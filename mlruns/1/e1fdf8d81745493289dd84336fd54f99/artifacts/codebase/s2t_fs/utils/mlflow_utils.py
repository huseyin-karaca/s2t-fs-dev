...
def log_experiment_results(search, wer_test, dataset_stats):
    ...
    # 2. Extract aggregated metrics for the best HPT trial
    ...
    results_dict = {
        ...
        "wer_cv_mean_train": get_cv_stat("mean_train_score"),
        "wer_cv_mean_test": get_cv_stat("mean_test_score"),
    ...
    mlflow.log_dict(results_dict, "results/results.json")
